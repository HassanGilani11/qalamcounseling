...
class Post_grid_two_col extends Widget_Base {

  
  public $base;

    public function get_name() {
        return 'element-ready-pro-multi-grid-post-two-col';
    }

    public function get_title() {
        return esc_html__( 'ER Two Column Grid', 'element-ready-pro' );
    }
    ...
    protected function register_controls() {
       ...
       do_action( 'er_section_general_grid_tab_two_col', $this, $this->get_name() );
      ...
      $this->add_control(
        ...
        [
          ...
          'step'    => 1,
          'selectors'	 => [
            '{{WRAPPER}} .er-readmore' => 'order: {{VALUE}};',
    ...
    $this->end_controls_section();
      ...
      $this->text_wrapper_css(
         array(
             ...
             'slug' => '_title_wra_box_style',
             'element_name' => '_title_rapper_element_ready_',
      ...
      $this->text_wrapper_css(
        array(
            ...
            'element_name' => '_title_per_element_ready_',
    ...
    $this->start_controls_section('newsprk_image_section',
        [
            'label' => esc_html__( 'Right Col Image ', 'element-ready-pro' ),
    ...
    $this->add_group_control(
     ...
     $this->add_responsive_control(
      ...
      [
         ...
         'size_units' => [ 'px','%'],
         'selectors'  => [
            '{{WRAPPER}} .er-news-style3 img'     => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
               '{{WRAPPER}} .er-news-style3 img'     => 'height: {{SIZE}}{{UNIT}};',
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
               '{{WRAPPER}} .er-news-style3 img'     => 'width: {{SIZE}}{{UNIT}};',
      ...
      $this->add_responsive_control(
        ...
        [
           ...
           'selectors' => [
              '{{WRAPPER}} .er-news-style3 img'     => 'max-width: {{SIZE}}{{UNIT}};',
           ],
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'size_units' => [ 'px'],
            'selectors'  => [
               '{{WRAPPER}} .er-news-style3 img'      => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
         ]
      );
   ...
   $this->start_controls_section('leftnews_image_section',
        [
    ...
    $this->add_group_control(
     ...
     $this->add_responsive_control(
      ...
      [
         ...
         'size_units' => [ 'px','%'],
         'selectors'  => [
            '{{WRAPPER}} .post-thumb img'     => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            '{{WRAPPER}} .er-post-thumb img'  => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
               ...
               '{{WRAPPER}} .er-post-thumb img'     => 'height: {{SIZE}}{{UNIT}};',
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
               ...
               '{{WRAPPER}} .er-post-thumb img'  => 'width: {{SIZE}}{{UNIT}};',
      ...
      $this->add_responsive_control(
        ...
        [
           ...
           'selectors' => [
              '{{WRAPPER}} .post-thumb img'     => 'max-width: {{SIZE}}{{UNIT}};',
              '{{WRAPPER}} .er-post-thumb img'  => 'max-width: {{SIZE}}{{UNIT}};',
           ],
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors'  => [
               ...
               '{{WRAPPER}} .er-post-thumb img'   => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
         ]
      );
   ...
   $this->end_controls_section();
     ...
     $this->text_wrapper_css(
        array(
            ...
            'selector' => '{{WRAPPER}} .er-readmore i',
        )
     ); 
     ...
     $this->box_css(
        array(
            ...
            'selector' => '{{WRAPPER}} .qs_newsp_post-style-5-item .post-contact, {{WRAPPER}} .er_qs_newsp_post-list-item',
      ...
      $this->box_css(
         array(
             ...
             'element_name' => '_content_ver_wer_wrapper_element_ready_',
             'selector' => '{{WRAPPER}} .qs_newsp_post-style-5-item,{{WRAPPER}} .er_qs_newsp_post-list-5',
        ...
        <div class="quomodo-container">  
            <div class="quomodo-row">
                <?php if($settings['block_style'] == 'style1'): ?>
                    <?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
                        ...
                        ?>
                         ...
                         <div class="quomodo-col-lg-12 quomodo-col-md-12" >
                         
                            <div class="qs_newsp_post-style-5-item post-scrolling-item mb-30">
                                        <?php if( has_post_thumbnail() ): ?>
                                            <div class="post-thumb er-post-thumb">
                ...
                <?php if($settings['block_style'] == 'style2'): ?>
                    <div class="quomodo-col-lg-12 quomodo-col-md-12">
                        <div class="qs_newsp_post-list-5 er_qs_newsp_post-list-5 mb-30">
                        <?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
                            <?php
                                $index = $wp_query->current_post + 1; 
                                
                            ?>
                                <div class="qs_newsp_post-list-item er_qs_newsp_post-list-item">
                                <h4 class="title er-news-title"><a href="<?php the_permalink() ?>"> <?php echo esc_html(wp_trim_words( get_the_title(),$settings['post_title_crop'], '' )); ?></a></h4>
                                    <div class="text er-post-thumb">
                                    <?php  $thumb_link = \Elementor\Group_Control_Image_Size::get_attachment_image_src( get_post_thumbnail_id( get_the_id() ), 'thumb_size', $settings ); ?>
                                        <img src="<?php echo esc_url( $thumb_link ); ?>" alt="<?php the_title_attribute(); ?>">
                                        <?php if($settings['show_content'] == 'yes'): ?>
                                            <p class="er-news-content"> <?php echo esc_html(wp_trim_words( get_the_excerpt(), $settings['post_content_crop'],'...' )); ?> </p>
                ...
                <?php if($settings['block_style'] == 'style3'): ?>
                    <?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
                        ...
                        ?>
                        <?php if($index == 1 ): ?>
                            <?php echo $index == 1?'<div class="quomodo-col-lg-8 quomodo-col-md-12">':''; ?> 
                         ...
                         <?php endif; ?>
                         <?php if( $index > 1 ): ?>
                            <?php echo $index == 2?'<div class="quomodo-col-lg-4 quomodo-col-md-12">':''; ?> 
                           
                               <div class="qs_newsp_post-list-item er_qs_newsp_post-list-item">
                                    <h4 class="title er-news-title"><a href="<?php the_permalink() ?>"> <?php echo esc_html(wp_trim_words( get_the_title(),$settings['post_title_crop'], '' )); ?></a></h4>
                                    <div class="text er-news-style3">
                                        <?php  $thumb_link = \Elementor\Group_Control_Image_Size::get_attachment_image_src( get_post_thumbnail_id( get_the_id() ), 'right_thumb_size', $settings ); ?>
                                        <img src="<?php echo esc_url($thumb_link); ?>" alt="<?php the_title_attribute(); ?>">
                                        <?php if($settings['show_content'] == 'yes'): ?>
                                            <p class="er-news-content"> <?php echo wp_kses_post(wp_trim_words( get_the_excerpt(), $settings['post_right_content_crop'],'' )); ?> </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
