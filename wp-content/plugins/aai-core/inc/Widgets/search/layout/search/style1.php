        ...
        <div class="element-ready-search-header">
            <h5 class="search-title">
                <?php if($settings['header_search_logo']['url'] !=''): ?>
                    <img src="<?php echo esc_url($settings['header_search_logo']['url']); ?>" alt="<?php echo esc_attr__('logo','element-ready-pro'); ?>">
                <?php endif; ?>
            </h5> <!-- search title -->
            ...
            <?php if($settings['custom_search_templte'] !='yes'): ?>
                <div class="element-ready-search-form">
                    <form method="get" action="<?php echo esc_url( home_url( '/' ) ) ?>">
                        <input type="search" value="<?php get_search_query(); ?>"  name="s" placeholder=" <?php echo esc_attr__('search here','element-ready-pro'); ?> ">
                        <button>
