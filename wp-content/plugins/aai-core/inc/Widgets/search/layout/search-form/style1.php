...
<div class="element_ready_search_layout_1">
    <form role="search" method="get" action="<?php echo esc_url( $cur_page_url ); ?>">
        <div class="wooready_input_wrapper display:flex">
            ...
            <div class="wooready_input_box flex-basis:<?php echo esc_attr($flex_basis);?> position:relative">
                <input type="text" placeholder="<?php echo esc_html($settings['search_palceholder']); ?>" value="<?php echo get_search_query(); ?>" name="s" title="<?php echo esc_attr_x( 'Search for:', 'label', 'shopready-elementor-addon' ); ?>" />
