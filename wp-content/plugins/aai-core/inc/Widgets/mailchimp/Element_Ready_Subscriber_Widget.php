<?php
namespace Element_Ready_Pro\Widgets\mailchimp;
...
class Element_Ready_Subscriber_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'ER Mailchimp Form', 'element-ready-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'mailchimp_post_url',
			[
				'label'       => __( 'MailChimp Post Url', 'element-ready-pro' ),
				'type'        => Controls_Manager::TEXTAREA,
				'placeholder' => __( 'MailChimp Post Url Here.', 'element-ready-pro' ),
				'description'   => wp_kses_post( '(<a href="'.esc_url('https://www.tassos.gr/blog/how-to-get-mailchimp-form-submit-url').'" target="_blank">See How To Get Post Url</a>)', 'element-ready-pro' ),
			]
		);
		...
		$this->add_control(
			'placeholder_text',
			[
				'label'       => __( 'Email Placeholder Text', 'element-ready-pro' ),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => __( 'mail@example.com', 'element-ready-pro' ),
			]
		);
