...
class Element_Ready_Fluent_Form_Widget extends Widget_Base {

    public function get_name() {
        return 'Element_Ready_Fluent_Form_Widget';
    }
    
    public function get_title() {
        return __( 'ER Fluent Forms', 'element-ready-pro' );
    }
    ...
    public function get_keywords() {
        return [ 'contact', 'contact form', 'Fluent Forms' ];
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'   => __( 'Contact Form', 'element-ready-pro' ),
                    'type'    => Controls_Manager::SELECT,
                    'options' => element_ready_fluent_form_list(),
                ]
            );
            ...
            $this->start_controls_tabs( 'input_radio_checkbox_tabs' );
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check' => 'display: {{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector' => '
                                {{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check,
                                {{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check label
                            ',
                        ]
                    );
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check' => 'color:{{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check' => 'height:{{SIZE}}{{UNIT}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check' => 'width:{{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check' => 'transition: {{SIZE}}s;',
                            ],
                        ]
                    );
                $this->end_controls_tab();
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type'      => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check:focus' => 'color:{{VALUE}};',
                        ],
                    ]
                );
                $this->add_group_control(
                    ...
                    [
                        ...
                        'types'    => [ 'classic', 'gradient' ],
                        'selector' => '
                            {{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check: focus
                        ',
                    ]
                );
                $this->add_control(
                    ...
                    [
                        ...
                        'type'      => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .element__ready__form__wrapper .ff-el-form-check:focus' => 'border-color:{{VALUE}};'
                        ],
                    ]
                );
                $this->add_group_control(
            ...
            <div <?php echo $this->get_render_attribute_string( 'element__ready__form__area__attr' ); ?> >
                <?php
                    if( !empty($settings['element_ready_contact_form_id']) ){
                        echo do_shortcode( '[fluentform  id="'.$settings['element_ready_contact_form_id'].'"]' ); 
                    }else{
