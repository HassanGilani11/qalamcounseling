...
class Element_Ready_Ninja_Form_Widget extends Widget_Base {

    public function get_name() {
        return 'Element_Ready_Ninja_Form_Widget';
    }
    
    public function get_title() {
        return __( 'ER Ninja Forms', 'element-ready-pro' );
    }
    ...
    public function get_keywords() {
        return [ 'contact', 'contact form', 'Ninja Forms' ];
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'   => __( 'Contact Form', 'element-ready-pro' ),
                    'type'    => Controls_Manager::SELECT,
                    'options' => element_ready_get_ninja_forms_list(),
                ]
            );
            ...
            <div <?php echo $this->get_render_attribute_string( 'element__ready__form__area__attr' ); ?> >
                <?php
                    if( !empty($settings['element_ready_contact_form_id']) ){
                        echo do_shortcode( '[ninja_form id="'.$settings['element_ready_contact_form_id'].'"]' ); 
                    }else{
